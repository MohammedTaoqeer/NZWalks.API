...
options.UseSqlServer(builder.Configuration.GetConnectionString("NZWalksConnnectionString")));
...
builder.Services.AddScoped<IImageRepository, LoacalImageRepository>();
