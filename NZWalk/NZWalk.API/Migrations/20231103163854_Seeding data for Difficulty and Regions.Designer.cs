...
namespace NZWalk.API.Migrations
{
    ...
    [Migration("20231103163854_Seeding data for Difficulty and Regions")]
            ...
            modelBuilder.Entity("NZWalk.API.Models.Domain.Difficulty", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("ba52950e-fc25-442d-b6ff-794bcd704bb9"),
                            Name = "Easy"
                        },
                        new
                        {
                            Id = new Guid("701512a6-0521-42b4-a2af-b0cdf191d95d"),
                            Name = "Medium"
                        },
                        new
                        {
                            Id = new Guid("7833fd6f-d427-4801-8d5b-39e4f557696f"),
                            Name = "Hard"
                        });
                });
            ...
            modelBuilder.Entity("NZWalk.API.Models.Domain.Region", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("7a8ccb36-78a6-4bee-89bc-f7f20383b485"),
                            Code = "AKL",
                            Name = "Aucland",
